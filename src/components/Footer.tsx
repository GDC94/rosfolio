            ...
            <motion.div variants={itemVariants}>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl bg-white border border-[#E0DBD6] flex items-center justify-center text-[#9A9A9A]">
                    {LocationIcon}
                  </div>
                  <div>
                    <p className="text-sm text-[#2D2D2D] font-medium">Tandil, Argentina</p>
                    <p className="text-xs text-[#9A9A9A]">GMT-3 · Trabajo remoto</p>
                  </div>
                </div>
