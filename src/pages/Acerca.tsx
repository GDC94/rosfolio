...
const xConsEvolution = {
  company: "XCONS",
  current: true,
  logo: "/src/assets/companys/xcons.png",
  roles: [
    {
      year: "2025",
      role: "Product Owner",
      description: "Lidero la visión del producto y priorizo el backlog. Coordinación entre equipos de diseño, desarrollo y stakeholders para entregar valor al usuario.",
      skills: ["Product Strategy", "Backlog Management", "Stakeholder Management"],
    },
    {
      year: "2024",
      role: "Product Designer",
      description: "Diseño de experiencias end-to-end para productos digitales. Investigación de usuarios, prototipado y validación de soluciones.",
...
const experiencias = [
  {
    ...
    logo: "/src/assets/companys/contexto.png",
    description: "Diseño de interfaces para aplicaciones bancarias. Creación de flujos de usuario optimizados y sistemas de diseño consistentes.",
    skills: ["Banking UX", "Design Systems", "Mobile Design"],
  },
  {
    year: "2024",
    role: "UX/UI Designer",
    logo: "/src/assets/companys/sci.png",
    company: "SCI - Supply Chain Institute",
    description: "Diseño de experiencias para plataformas de gestión de cadena de suministro. Simplificación de procesos complejos en interfaces intuitivas.",
...
function Acerca() {
  ...
  const [certificateModal, setCertificateModal] = useState<{ isOpen: boolean; url: string; title: string }>({
    isOpen: false,
    url: "",
    title: "",
  });
      ...
      <main className="pt-20 sm:pt-24 md:pt-28 pb-16 max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 relative z-10">
          ...
          <div className="relative">
            ...
            <div className="relative py-8">
              ...
              <div className="relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-20 items-center">
                ...
                >
                  <div className="relative">
                    ...
                    <div className="relative w-64 h-80 md:w-72 md:h-96">
                      ...
                      >
                        {[...Array(9)].map((_, i) => (
                          <div key={i} className="w-1.5 h-1.5 rounded-full bg-[rgb(201,188,63)]/40" />
                        ))}
                      </motion.div>
                ...
                <div className="lg:col-span-7">
                  ...
                  >
                    <motion.div
                      className="h-[1px] w-12 bg-[rgb(201,188,63)] origin-left lg:origin-left"
                      initial={{ scaleX: 0 }}
                      animate={isHeroInView ? { scaleX: 1 } : {}}
                  ...
                  <div className="mb-6 text-center lg:text-left">
                    <div className="overflow-hidden pb-1">
                      <motion.h1
                        className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light text-[#2D2D2D] tracking-tight"
                        initial={{ y: 80 }}
                    ...
                    <div className="overflow-hidden pb-2">
                      <motion.h1
                        className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light text-[#2D2D2D]"
                        initial={{ y: 80 }}
                        animate={isHeroInView ? { y: 0 } : {}}
                  ...
                  >
                    <p className="text-base md:text-lg text-[#4A4A4A] leading-relaxed">
                      UX/UI Designer y Product Designer con experiencia en productos digitales para 
                      <span className="text-[#2D2D2D] font-medium"> tecnología </span>y
                      <span className="text-[#2D2D2D] font-medium"> banca</span>.
                      Mi formación en Arquitectura me brindó una base sólida en pensamiento espacial y resolución de problemas.
                    </p>
                    <p className="text-base md:text-lg text-[#6B6B6B] leading-relaxed">
                      Actualmente trabajo como Product Owner en XCONS, liderando la visión de producto y colaborando con equipos multidisciplinarios.
                    </p>
                  </motion.div>
                  ...
                  >
                    ...
                    <div className="flex gap-2">
                      ...
                      <a
                        ...
                        title="Behance"
                      >
                        <svg width="20" height="12" viewBox="0 0 22 14" fill="currentColor">
            ...
            >
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 md:gap-8 lg:gap-12 max-w-3xl mx-auto text-center">
                <StatItem number={3} suffix="+" label="Años de experiencia" delay={1.2} isInView={isHeroInView} />
                <StatItem number={4} suffix="+" label="Empresas" delay={1.3} isInView={isHeroInView} />
                <StatItem number={5} suffix="+" label="Certificaciones" delay={1.4} isInView={isHeroInView} />
                <StatItem number={15} suffix="+" label="Clientes" delay={1.5} isInView={isHeroInView} highlight />
              </div>
            </motion.div>
          </div>
        </motion.section>
            ...
            {educacion.map((edu, index) => (
              ...
              >
                <div className="flex items-start justify-between mb-2 gap-2">
                  <h3 className="text-sm sm:text-base font-medium text-[#2D2D2D]">{edu.title}</h3>
                  <span className="text-xs text-[#9A9A9A] whitespace-nowrap flex-shrink-0">{edu.year}</span>
                </div>
                <p className="text-xs sm:text-sm text-[rgb(111,141,181)] mb-1">{edu.institution}</p>
                <p className="text-[10px] sm:text-xs text-[#9A9A9A]">{edu.period}</p>

                {/* Icons for certificates */}
                {edu.certificate && (
                  <div className="absolute bottom-4 right-4 flex items-center gap-2">
                    {/* Trophy icon - only for UX/UI courses */}
                    {(edu.title === "Diseño UX/UI Inicial" || edu.title === "Diseño UX/UI Avanzado") && (
                      <div
                    ...
                    <button
                      onClick={() => setCertificateModal({ isOpen: true, url: edu.certificate!, title: edu.title })}
        ...
        >
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 justify-center lg:justify-start">
            <div className="px-4 sm:px-5 py-2.5 sm:py-3 bg-white/50 backdrop-blur-sm rounded-xl border border-[#E0DBD6]/50">
              <span className="text-sm sm:text-base text-[#2D2D2D] font-medium">Español</span>
              <span className="text-xs sm:text-sm text-[#9A9A9A] ml-2">Nativo</span>
            </div>
            <div className="px-4 sm:px-5 py-2.5 sm:py-3 bg-white/50 backdrop-blur-sm rounded-xl border border-[#E0DBD6]/50">
              <span className="text-sm sm:text-base text-[#2D2D2D] font-medium">Inglés</span>
              <span className="text-xs sm:text-sm text-[#9A9A9A] ml-2">A2 (en formación)</span>
            </div>
          </div>
        </motion.section>
        ...
        >
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3 justify-center lg:justify-start">
            {[
              "Figma", "Figma Sites", "Canva", "Sketchup", "Marvel",
              "Trello", "Jira", "Odoo", "Notion", "Slack",
              "Maze", "Optimal Workshop", "Deep Research",
        ...
        {certificateModal.isOpen && (
          ...
          >
            ...
            <motion.div
              ...
              animate={{ opacity: 1 }}
              exit={{ opacity: 0 }}
              onClick={() => setCertificateModal({ isOpen: false, url: "", title: "" })}
            />
            ...
            >
              ...
              <div className="flex items-center justify-between px-6 py-4 border-b border-[#E0DBD6]">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-medium text-[#2D2D2D]">Certificado</h3>
                    <p className="text-sm text-[#6B6B6B]">{certificateModal.title}</p>
                  </div>
                </div>
                <button
                  onClick={() => setCertificateModal({ isOpen: false, url: "", title: "" })}
...
const StatItem = ({
  ...
  return (
    <div className="text-center">
      <div className={`text-3xl sm:text-4xl md:text-5xl font-light tracking-tight mb-1 sm:mb-2 ${
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-1/2 md:left-24 -translate-x-1/2 top-6 md:top-0 flex items-center justify-center z-10">
        <div className={`w-4 h-4 rounded-full border-2 ${current ? "bg-[rgb(201,188,63)] border-[rgb(201,188,63)]" : "bg-white border-[#E0DBD6]"}`}>
          {current && (
      ...
      <div className="absolute left-0 md:left-0 top-0 md:w-20 text-right hidden md:block">
        <span className={`text-sm font-medium ${current ? "text-[rgb(201,188,63)]" : "text-[#9A9A9A]"}`}>
          {year}
        </span>
        {current && (
          <span className="block text-xs text-[rgb(111,141,181)]">Presente</span>
        )}
      </div>
      ...
      <div className="md:hidden mb-3 text-center w-full pt-12">
        <span className={`text-sm font-medium ${current ? "text-[rgb(201,188,63)]" : "text-[#9A9A9A]"}`}>
          {year} {current && <span className="text-[rgb(111,141,181)]">· Presente</span>}
        </span>
      </div>

      {/* Content card */}
      <div className="relative bg-white/50 backdrop-blur-sm rounded-xl p-4 sm:p-5 md:p-6 border border-[#E0DBD6]/50 hover:border-[rgb(201,188,63)]/30 transition-all duration-300 hover:shadow-lg hover:shadow-black/5 w-full sm:w-fit mx-auto lg:mx-0">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between mb-2 sm:mb-3">
          <div className="flex-1 text-center lg:text-left">
            <h3 className="text-base sm:text-lg font-medium text-[#2D2D2D] mb-1">{role}</h3>
            <div className="flex items-center justify-center lg:justify-start gap-2">
              {logo && (
                <div className="p-1 bg-[rgb(201,188,63)]/15 rounded-md">
                  <img src={logo} alt={company} className="w-4 h-4 object-contain opacity-70" loading="lazy" />
                </div>
              )}
              <p className="text-xs sm:text-sm text-[rgb(111,141,181)]">{company}</p>
            </div>
          </div>
        </div>

        <p className="text-xs sm:text-sm text-[#6B6B6B] leading-relaxed mb-3 sm:mb-4 text-center lg:text-left">
          {description}
        </p>
        ...
        <div className="flex flex-wrap gap-1.5 sm:gap-2 justify-center lg:justify-start">
          {skills.map((skill) => (
            <span
              key={skill}
              className="px-2 sm:px-2.5 py-0.5 sm:py-1 bg-[rgb(201,188,63)]/15 text-[rgb(161,148,23)] text-[10px] sm:text-xs font-medium rounded-md"
            >
              {skill}
            </span>
          ))}
    ...
    >
      ...
      <div className="absolute left-0 md:left-0 top-0 md:w-20 text-right hidden md:block">
        <span className="text-sm font-medium text-[rgb(201,188,63)]">
          {data.roles[data.roles.length - 1].year} - {data.roles[0].year}
        </span>
        <span className="block text-xs text-[rgb(111,141,181)]">Presente</span>
      </div>
      ...
      <div className="md:hidden mb-3 text-center w-full pt-12">
        <span className="text-sm font-medium text-[rgb(201,188,63)]">
          {data.roles[data.roles.length - 1].year} - {data.roles[0].year} <span className="text-[rgb(111,141,181)]">· Presente</span>
        </span>
      </div>
        ...
        <div className="px-6 py-4 bg-gradient-to-r from-[rgb(201,188,63)]/10 to-transparent border-b border-[rgb(201,188,63)]/20 flex items-center">
          {data.logo && (
            <div className="p-1.5 bg-[rgb(201,188,63)]/15 rounded-md mr-3">
              <img src={data.logo} alt={data.company} className="w-4 h-4 object-contain opacity-70" />
            </div>
          )}
            ...
            <div className="space-y-6">
              {data.roles.map((roleData, index) => {
                ...
                return (
                  ...
                  >
                    {/* Step indicator */}
                    <div className={`absolute left-0 top-1 w-4 h-4 rounded-full border-2 ${isFirst
                    ...
                    <div className={`${isFirst ? "" : "opacity-75"}`}>
                      <div className="flex items-center gap-3 mb-1">
                        <span className={`text-base font-medium ${isFirst ? "text-[#2D2D2D]" : "text-[#6B6B6B]"}`}>
                          {roleData.role}
                        </span>
                        <span className="text-xs text-[#9A9A9A]">{roleData.year}</span>
                      </div>
